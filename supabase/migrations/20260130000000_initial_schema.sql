...
CREATE TABLE IF NOT EXISTS dogs (
    ...
    kennel TEXT,
    description TEXT,
    sterilization_status TEXT DEFAULT 'Pending' CHECK (sterilization_status IN ('Sterilized', 'Not Sterilized', 'Pending')),
    vaccination_status TEXT DEFAULT 'Pending' CHECK (vaccination_status IN ('Up to Date', 'Incomplete', 'Overdue', 'Pending')),
    medical_checkup_status TEXT DEFAULT 'Pending' CHECK (medical_checkup_status IN ('Completed', 'Incomplete', 'Pending', 'Overdue')),
    medical_priority TEXT CHECK (medical_priority IN ('Special Needs', 'Senior Care', 'Medication Required', 'Behavioural Support', 'Normal', 'Low', 'High', 'Urgent') OR medical_priority IS NULL),
    images TEXT[] DEFAULT '{}',
